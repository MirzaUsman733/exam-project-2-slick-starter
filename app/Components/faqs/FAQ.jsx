const faqData = [
  {
    ...
    items: [
      ...
      {
        question: "Can I pass Exam with dumpsarena.com Questions and Answers product only?",
      ...
      },
      {
        ...
        answer: `Yes, when the 90 days of your product validity are over, you have the option of renewing your expired products with additional discount. This can be done in your Member's Area.
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: `Why to waste time on questions that are out-dated? During the Product Updates the older questions that no longer form the part of real Exam are removed and that is why Product might be left with lesser number of questions. This actually means that you have to study fewer questions and pass with higher scores.`
      }
    ]
  },
  {
    ...
    items: [
      {
        question: "What is a PDF Version?",
        answer: `The PDF version is simply a portable document copy of your Questions and Answer Product. This is a world standart .pdf file which contains all questions and answers and can be read by official Acrobat by Adobe or any other free reader application.`
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: `Login to your account here and you will see your invoice number next to your product and the download button. You can then download purchased product without delay.`
      }
    ]
  },
  {
    category: "Login Failed & Solutions",
    items: [
      {
        question: "I have placed an order, but when I enter the user center I do not see any active Products for downloading, what is the problem?",
        answer: `Please make sure that the transaction was successful. Make sure that you are logging into correct account. If you think that you are doing it correctly and issue is still not resolved please contact our Support Team.`
      },
      {
        question: "After login, I am taken back to the home page, How can I login my members area?",
      ...
      {
        question: "I have forgot my Password or system is not accepting password? What should I do?",
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: "Is my credit card information secure at your site and how secure is your website?",
      ...
      {
        question: "I am trying to Pay for my product, but I always get 'unauthorized' message. How can I pay for it?",
      ...
      },
      {
        ...
        answer: `Special Discount is offered for popular certifications and exams. If you want to buy three or more products please contact Support Team for getting discount.`
      },
      {
        question: "I Used dumpsarena.com Questions and Answers Product and failed how can I ask for a refund?",
      ...
      {
        question: "Does a third party can see your customers' information from your website?",
        answer: `No, they can not. Our system is fully secured and we do not share any information with third partied.`
      }
    ]
  },
  {
    ...
    items: [
      {
        question: "How many Premium PDF files can be downloaded with Unlimited Access?",
        answer: `Any 15 Premium PDF files can be Downloaded per month if you buy Unlimited Access for any duration.`
      }
    ]
  },
  {
    ...
    items: [
      {
        question: "How many Premium PDF files can be downloaded with Reseller Access?",
        answer: `You can download unlimited PDF files if you buy Reseller Access for any duration. There are no download limits.`
      }
    ]
  },
  {
  ...
  {
    category: "Free Bonus PDF File",
    items: [
      {
        question: "What is FREE bonus PDF File?",
        answer: `Free bonus PDF Files are provided by our new experts, so we are giving them FREE with premium files. Please follow our Premium Files for preparations, correct and verified answers.`
      }
    ]
  },
  {
    ...
    items: [
      {
        question: "I took the exam today and failed how can I ask for a refund?",
...
const FAQ = () => {
   return (
    <div className="container mx-auto p-5 my-8 shadow-lg md:my-16">
        <h1 className="text-4xl text-center font-bold mb-10">Frequently Asked Questions</h1>
      <div className="flex gap-10">
        <ul className={`cd-faq-categories w-full max-h-[50%]  md:w-1/5 bg-blue-500 text-white shadow-md`} style={{maxHeight: "60vh"}}>
          {faqData.map((section, index) => (
            <li key={index}>
              <a href={`#`} className={`block px-6 py-3 border-b border-white `}>{section.category}</a>
            </li>
          ))}
        </ul>
        ...
        <div className={`cd-faq-items w-full md:w-4/5 p-4 bg-white`}>
          {faqData.map((section, index) => (
            <div id={section.category.replace(/ /g, '-')} key={index} className="border-b mb-3">
              ...
              <div>
                {section.items.map((item, idx) => (
                  <div className="mb-4" key={idx}>
                    <div className="cd-faq-trigger text-xl font-semibold mb-3">{idx + 1}. {item.question}</div>
