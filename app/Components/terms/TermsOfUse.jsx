        ...
        <div className="container mx-auto p-6">
            ...
            <nav className="mb-8">
                <ul className="list-disc list-inside space-y-2">
                    <li><a href="#website-usage" className="text-blue-500 hover:text-blue-700">Website Usage</a></li>
                    <li><a href="#third-party-links" className="text-blue-500 hover:text-blue-700">Third-Party Websites and Services Links</a></li>
                    <li><a href="#changes-updates" className="text-blue-500 hover:text-blue-700">Changes and Updates to the Website</a></li>
                    <li><a href="#liability" className="text-blue-500 hover:text-blue-700">Exclusion of Liability</a></li>
                    <li><a href="#copyright" className="text-blue-500 hover:text-blue-700">Copyright and Trade Marks</a></li>
                    <li><a href="#force-majeure" className="text-blue-500 hover:text-blue-700">Force Majeure</a></li>
                    <li><a href="#profile" className="text-blue-500 hover:text-blue-700">Creating Profile at the Website</a></li>
                    <li><a href="#data-protection" className="text-blue-500 hover:text-blue-700">Data Protection and Privacy</a></li>
                    <li><a href="#jurisdiction" className="text-blue-500 hover:text-blue-700">Jurisdiction and Governing Law</a></li>
                </ul>
            </nav>
            ...
            <main className="space-y-8">
                ...
                <section id="third-party-links">
                    <h2 className="text-2xl font-bold text-gray-800">Third-Party Websites and Services Links</h2>
                    <p className="text-gray-700 mt-4">
                ...
                <section id="changes-updates">
                    <h2 className="text-2xl font-bold text-gray-800">Changes and Updates to the Website</h2>
                    <p className="text-gray-700 mt-4">
                ...
                <section id="liability">
                    <h2 className="text-2xl font-bold text-gray-800">Exclusion of Liability</h2>
                    <p className="text-gray-700 mt-4">
...
The website is provided without any endorsements on an "AS AVAILABLE" and "AS IS" and there is no warranty of any kind.
                ...
                <section id="copyright">
                    <h2 className="text-2xl font-bold text-gray-800">Copyright and Trade Marks</h2>
                    <p className="text-gray-700 mt-4">
                ...
                <section id="profile">
                    <h2 className="text-2xl font-bold text-gray-800">Creating Profile at the Website</h2>
                    <p className="text-gray-700 mt-4">
                ...
                <section id="data-protection">
                    <h2 className="text-2xl font-bold text-gray-800">Data Protection and Privacy</h2>
                    <p className="text-gray-700 mt-4">
                ...
                <section id="jurisdiction">
                    <h2 className="text-2xl font-bold text-gray-800">Jurisdiction and Governing Law</h2>
                    <p className="text-gray-700 mt-4">
                        If any difference or dispute arises, then the UK courts shall have full Jurisdiction over them. The dispute can be in or out of connection with the use of the Website...
                    </p>
                </section>
            </main>
            ...
            <footer className="mt-12">
                <div className="flex items-center">
                    ...
                    <label htmlFor="agree" className="text-gray-800">I have read and agree to the Terms of Use</label>
                </div>
                <div className="mt-4 flex space-x-4">
                    <button className="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-700">Agree</button>
                    <button className="bg-gray-200 text-gray-800 py-2 px-4 rounded hover:bg-gray-300">Cancel</button>
                </div>
            </footer>
        </div>
    );
