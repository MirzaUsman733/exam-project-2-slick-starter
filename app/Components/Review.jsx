...
//                 <span className="review__stars">⭐️⭐️⭐️⭐️⭐️</span>
//             </h4>
...
//                 <span className="review__stars">⭐️⭐️⭐️⭐️⭐️</span>
//             </h4>
//             <p className="review__content">Love your plugins and support!!!!!!! I’m going to use them on my.new sites going
//                 forward </p>
...
//                 <span className="review__stars">⭐️⭐️⭐️⭐️⭐️</span>
//             </h4>
//             <p className="review__content">It’s hard for a not native english speaking to understand the construction. At
...
//                 <span className="review__stars">⭐️⭐️⭐️⭐️⭐️</span>
//             </h4>
//             <p className="review__content">Wow that was fast support!!! Thank you that works 🙂</p>
    ...
    <div className="grid grid-cols-5 gap-8 p-4">
      {reviews.map((review, index) => (
        <div key={index}
             ...
             onMouseOver={(e) => e.currentTarget.classList.add('shadow-lg', 'border', 'border-gray-600')}
             onMouseOut={(e) => e.currentTarget.classList.remove('shadow-lg', 'border', 'border-gray-600')}>
          <div className="img-container w-36 h-36 rounded-full overflow-hidden mx-auto mb-4">
            <img src={review.image} alt={review.alt} className="w-full h-full object-cover" />
          </div>
