...
const OtherRelatedExam = async ({ vendorPerma }) => {
  ...
  const relatedExamData = await fetchRelatedExamData();
    ...
    <div className="container mx-auto p-6 mt-10">
      ...
      {shuffledData?.slice(0, 5)?.map((examCart) => (
        ...
        >
          ...
          {/* <div className="grid">
            <div className="flex items-center justify-between bg-gray-500 p-3">
              <div className="flex items-center gap-2">
                <img
                  src="https://dumpsboss.com/media/hot-certs/capm-min.png"
                  className="w-12"
                  alt=""
                />
                <div className="grid">
              ...
              <div className="">
                <div className="text-end mb-1">
                  <span className="bg-indigo-100 text-indigo-800 text-xs font-medium px-1.5 py-0.5 rounded-lg dark:bg-gray-700 dark:text-indigo-400 border border-indigo-400">
                    4.6
                  </span>
                </div>
            ...
            <hr className="border my-0 py-0" />
            <div className="grid gap-2 p-3">
              <h3 className="font-semibold text-gray-600 text-md">
                {examCart?.exam_title}
              </h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Prepare for the {examCart?.vendor_perma} {examCart?.exam_code}
...
export default OtherRelatedExam;
