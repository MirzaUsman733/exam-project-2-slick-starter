    ...
    <div className="container mx-auto px-4 py-8">
      <div className="w-full mx-auto bg-white shadow rounded-lg blog-content">
        <div className="px-5 py-3 border-b border-gray-200">
          <div className="md:flex lg:justify-between lg:items-start mb-4">
            {data?.blog_image && (
              <div className="relative w-full block lg:hidden lg:w-4/12 ms-auto rounded-lg overflow-hidden">
                <img
                  src={data.blog_image}
            ...
            <div className="flex lg:hidden flex-wrap gap-3 mt-5 text-sm text-gray-500 mb-4">
            ...
            <div className="w-full lg:w-8/12">
              <h1 className="text-lg font-semibold lg:text-4xl lg:font-bold mb-2">
            ...
            {data.blog_image && (
              <div className="relative w-full hidden lg:block lg:w-4/12 ms-auto rounded-lg overflow-hidden">
                <img
                  src={data.blog_image}
                  alt={data.blog_title || "Blog image"}
                  className="max-w-96 ms-auto"
