      ...
      <div className="overflow-hidden my-4 grid grid-cols-1 md:grid-cols-3 w-full gap-0 md:gap-28 font-[lato]">
        <div className="col-span-1 w-full">
          <img
            ...
            className="w-full"
          />
          <div className="text-center text-xs md:text-base px-2 py-3 md:p-5 pb-0">
        ...
        <div className="flex-grow col-span-2">
          ...
          <p className="text-xs md:text-lg text-gray-600 mb-4">
            ...
            AWS certification exam. Pass the Amazon AWS DAS-C01 test with flying
            colors.
          </p>
          <div className="flex flex-wrap justify-between items-center text-lg text-gray-700 mb-4">
